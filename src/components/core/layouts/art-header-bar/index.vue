    ...
    <div class="menu">
      ...
      <div class="right">
        ...
        <div class="user">
          ...
          >
            <template #reference>
              <img class="cover" src="@/assets/img/avatar/avatar.png" />
            </template>
            <template #default>
              <div class="user-menu-box">
                <div class="user-head">
                  <img class="cover" src="@/assets/img/avatar/avatar.png" style="float: left" />
                  <div class="user-wrap">
                    <span class="name">{{ userInfo.username }}</span>
                    <span class="email" v-if="userInfo.role">{{ userInfo.role }}</span>
                  </div>
                </div>
                <ul class="user-menu">
